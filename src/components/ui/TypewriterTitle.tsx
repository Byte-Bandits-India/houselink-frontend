...
export default function TypewriterTitle({
  ...
  className = "relative mx-auto w-full max-w-4xl py-24",
  textClassName = "flex items-center gap-1 font-mono text-4xl text-black tracking-tight md:text-6xl dark:text-white",
  cursorClassName = "inline-block h-[1em] w-[3px] bg-black dark:bg-white",
  contentClassName = "relative z-10 flex flex-col items-center justify-center text-center",
