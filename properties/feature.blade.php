...
@section('head')
    <style>
        ...
        .image-wrapper:hover .image-overlay-link {
            display: block;
        }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box">
                        <h1><span class="animated-text"><span class="selected-city-name"></span> Featured Properties</span></h1><br>
...
@section('styles')
    <style>
        ...
        .page-header {
            background: url("{{ asset('assets/images/footer/feature_image.png')}}");
        }
                                    ...
                                    <form class="form-row align-items-center row">
                                        ...
                                        <div class="col-md-2 rightsideborder mb-2">
                                            ...
                                            <select class="form-select" name="category" id="category">
                                                ...
                                                @php $hasCommercial = false; @endphp
                                                @foreach ($category as $cat)
                                                    @if($cat->group === 'residential')
                                                        <option value="{{ $cat->id }}">{{ $cat->name }}</option>
                                                    @elseif($cat->group === 'commercial')
                                                        @php $hasCommercial = true; @endphp
                                                    @endif
                                                @endforeach
                                                @if($hasCommercial)
                                        ...
                                        <div class="col-md-3  mb-2">
                                            <div class="d-flex gap-2 buttongroup">
                                                ...
                                                <button class="btn btn-primary w-50 search-btn"><i
                                            ...
                                            <div class="col-lg-12">
                                                <div class="our-Project-nav wow fadeInUp" data-wow-delay="0.4s">
                                                    <ul>
                                                        ...
                                                        <li id="plots-nav-item"><a href="#" onclick="loadCityAndCategoryProjects(selectedCityId, 3)">Plots</a></li>
                                                        ...
                                                        <li><a href="#" onclick="loadCityAndCategoryProjects(selectedCityId, 'commercial')">Commercial Property</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
            ...
            try {
                ...
                $.each(properties, function (index, property) {
                    ...
                    const url = permalink 
                        ...
                        : `${baseUrl}/${id}`;
                    const isInWishlist = wishlistIds.map(Number).includes(Number(id));
...
if (categoryId == 1 || categoryId == 2 || categoryId == 4) {
    ...
    `;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response && Array.isArray(response.properties)) {
                        ...
                        filterHandler();
                        console.log(`Projects loaded: ${response.properities.length}`);
                    } else {
        ...
        function loadCityAndCategoryProjects(cityId, categoryId = null) {
            let url = '/features/properties/search/?city=' + cityId + '&property_purpose=' + window.currentPropertyPurpose;
            if (categoryId) {
        ...
        $(document).ready(function () {
            ...
            window.currentPropertyPurpose = 'sell';
            ...
            window.switchPropertyFilter = function(type) {
                ...
                const cityId = $('select[name="city"]').val();
                let url = '/features/properties/search/?city=' + cityId + '&property_purpose=' + type;
                $.ajax({
                    url: url, method: 'GET',
                    success: function(response) {
                        if (response && Array.isArray(response.properties)) {
            ...
            $('.search-btn').on('click', function (e) {
                ...
                $.ajax({
                    url: '/features/properties/search',
                    method: 'GET',
                    data: data,
                    success: function (response) {
                        if (response && Array.isArray(response.properties)) {
